...
Característica: Cobertura PrestamoService
  ...
  Escenario: Calcular recargo A para préstamo nulo
    ...
    Entonces el recargo A devuelto es 0
  ...
  Escenario: Calcular multa para préstamo nulo
    ...
    Entonces la multa devuelta es 0
